...
from comfyui_client import CommandBase
from comfyui_client.Commons import set_debug, set_verbose, error
from comfyui_client.Version import __version__
...
if __name__ == '__main__':
    ...
    parser.add_argument("--version", action="version", version=f"ComfyUIClient {__version__}")
    parser.add_argument("--verbose", action="store_true", default=False, help="Enable informational logging (info-level messages).")
    parser.add_argument("--debug",   action="store_true", default=False, help="Enable verbose low-level debug logging.")
